...
**Figure 1. Day of the week appears to have little impact on daily perceived stress level.** The pink circles represent a single day's self-reported stress level on a scale of 1-5. They are jittered and semi-transparent to show overlapping points. Days of the week are represented on th x axis, ordered from Monday to Sunday. There appears to be examples of low stress everyday of the week and high stress almost everyday. Tuesdays, Fridays, and Sundays tend to be lower stress. Thursdays appear to be the highest stress day of the week. Day of the week is the categorical predictor variable and stress is the response variable.

**Figure 2. There appears to be a potential negative linear relationship between perceived stress level and daily step count.** The navy blue dots represent a single day's self-reported stress level on a scale of 1-5 and are ordered on the x axis by daily step count recorded by a fitbit watch. Daily step count is the discrete predictor variable and stress is the response variable. 
